...
import './Stock.css'; // Your styles for this component
...
export default function StockList({ user }) {
  ...
  const handleRestock = async (product) => {
    ...
    try {
      // ✅ --- THIS IS THE FIX --- ✅
      // The endpoint for updating stock is now '/api/products'
      const response = await API.post('/api/products', {
        barcode: product.barcode,
        quantity: quantityToAdd,
        updateStock: true, // This flag tells the backend to update, not create
      });
